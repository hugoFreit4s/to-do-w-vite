...
type Props = {
    ...
    onClickArchiveTask: React.MouseEventHandler<HTMLButtonElement>;
}
const TaskElement = ({ task, onClickConfirmRemoveButton: removeFunction, onClickCheckTask: checkTaskFunction, onClickArchiveTask: archiveTaskFunction }: Props) => {
    ...
    return (
        <div className={`task_div`}>
            ...
            <div className="task_buttons">
                <div onClick={() => setIsRemoveModalOpen(true)}><svg id="remove_svg" className="tasks_svg" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
                ...
                <div onClick={() => setIsEditModalOpen(true)}><svg id="edit_svg" className="tasks_svg" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
                ...
                <div onClick={() => setIsArchiveModalOpen(true)}>
                    <svg id="archive_svg" className="tasks_svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h5l2 2h9a2 2 0 0 1 2 2z"></path>
                    </svg>
                </div>
            </div>
            {isArchiveModalOpen && <div className="modal_backdrop">
                <div className="modal_content archive_modal_content">
                    <div className="remove_message">
                        <p id="remove_modal_main_text">Are you sure you want to archive the task?</p>
                    </div>
                    <div className="remove_modal_buttons">
                        <button id="cancel_button" className="modal_buttons" onClick={() => setIsArchiveModalOpen(false)}>Cancel</button>
                        <button id="confirm_button" className="modal_buttons" onClick={(e) => {
                            archiveTaskFunction(e);
