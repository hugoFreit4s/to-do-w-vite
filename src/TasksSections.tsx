...
const TaskSections = ({ allTasksAmount, openTasksAmount, closedTasksAmount, archivedTasksAmount, functions }: Props) => {
    return (
        <div id="sections_div">
            ...
            <div className="section" id="open_section">Open<span>{openTasksAmount}</span></div>
            <div className="section" id="closed_section">Closed<span>{closedTasksAmount}</span></div>
            <div className="section" id="archived_section">Archived<span>{archivedTasksAmount}</span></div>
        </div>
    )
}
